...
var manaquartz = <Botania:quartz:1>;
var manaquartzB = <Botania:quartzTypeMana>;
...
mods.botania.ManaInfusion.removeRecipe(quartz);
mods.botania.ManaInfusion.removeRecipe(manaquartz);
mods.botania.ManaInfusion.removeRecipe(manaquartz);
...
mods.botania.ManaInfusion.addAlchemy(glowstone * 4, glowstoneB, 1000);
...
mods.botania.ManaInfusion.addInfusion(manaquartz, quartz, 1000);
mods.botania.ManaInfusion.addAlchemy(manaquartz * 4, manaquartzB, 1000);
